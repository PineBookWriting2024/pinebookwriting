...
export default function BookEditing() {
    ...
    return (
        <>
            ...
            <BrandNavbar />
            <BrandPrimaryHeader
                photo_banner={"/brand-img/Memoir-Writing.png"}
            ...
            <div className="container mx-auto max-w-screen-xl overflow-hidden pt-0 md:py-20">
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-8 md:px-0 py-10 md:py-0">
                    ...
                    <h2 className="font-poppins text-3xl md:text-4xl uppercase font-bold">Hire Memoir Writing Service and Preserves Your Memories</h2>
                        ...
                        <p className="font-poppins text-xl text-left pt-3">Tell your story to us. We'll write it in professional manners, and make it absolutely readable and engaging for your audience. Our team of memoir writers provides excellence by looking for the points that will crown your story. So why wait? Let's discuss your memoir writing project now!</p>
                    </div>
