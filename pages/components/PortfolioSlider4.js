    ...
    return (
        <>
            <div className="w-full max-w-6xl mx-auto py-10 relative">
                <h1 className="md:text-4xl text-3xl  font-bold mb-20 text-center">Our Portfolio - From Designing,<br></br> Formatting to Publishing</h1>
                <h2 className="text-3xl font-medium mb-5 text-center md:text-left">Editing, Formatting & Proofreading</h2>
