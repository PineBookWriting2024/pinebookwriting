...
export default function BookEditing() {
    ...
    return (
        <>
            <Head>
                <title>Wiki Writing | Pine Book Writing</title>
                <meta
                    name="description"
            ...
            <BrandNavbar />
            <BrandPrimaryHeader
                photo_banner={"/brand-img/Wiki-Writing.png"}
                title="Build Online Authority with Our Wikipedia Writing Services"
                desc="Our wiki writing services will help you build your credibility by giving you professionally written, well-sourced content that fulfills platform standards and helps you build a respected online presence. Contact us today!"
            />
            <BrandBannerLogo />
            ...
            <div className="container mx-auto max-w-screen-xl overflow-hidden pt-0 md:py-20">
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-8 md:px-0 py-10 md:py-0">
                    <div className="basis-1/2 abt-txt m1-h p1 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
                        <h2 className="font-poppins text-3xl md:text-4xl uppercase font-bold">A Reliable Wiki Writing Service</h2>

                        <h2 className="font-poppins text-2xl md:text-3xl uppercase">
                            Verified content, presented professionally
                        </h2>

                        <p className="font-poppins text-xl text-left pt-3">
                            Our wiki writing services assist people, businesses, and groups in building a reliable online world presence. We do a lot of research, follow formatting rules, and make sure your information fulfills the standards for notability set by big sites like Wikipedia. </p>

                        <p className="font-poppins text-xl text-left pt-3">We write unbiased, well-sourced pieces that clearly and accurately show off your accomplishments, from bios to corporate profiles. We help you with the whole process, from submitting your first piece of content to getting it approved. Why wait? Build your notable online presence with us!</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-4 max-w-8xl mx-auto relative ">
                    ...
                    <div className="md:col-span-3 hidden md:flex justify-center md:justify-start relative z-10">
                        <Image
                            ...
                            alt="Book 1"
                            className="l-book absolute -top-20 md:-top-48 left-28"
                            height={400}
                            width={400}
                        />
                    </div>
                    ...
                    <div className="md:col-span-6 text-center px-4">
                        ...
                        <p className="text-base md:text-lg py-4">Create well-written and well-researched wiki pages to tell the world about you and your success.</p>
                ...
                <div className="brand-choose-us-section ms-auto relative left-0 md:left-52 px-12 md:px-20 md:mt-16 mb-8 py-10 " >
                    <div className="flex items-center flex-col md:flex-row" data-aos="fade-right" data-aos-delay="0" data-aos-duration="500">
                        ...
                        <div className="basis-1/2 md:ml-20">
                            ...
                            <div>
                                <button type="button" className="brand-nav-btn-1 brand-nav-btn shadow-xl mt-10 cursor-pointer btn-f" onClick={handleOpenChat}>Speak to our Consultant</button>
