...
export default function BookEditing() {
    ...
    return (
        <>
            ...
            <BrandNavbar />
            <BrandPrimaryHeader
                photo_banner={"/brand-img/Novel-Writing.png"}
                title="Novel Writing Service that Truly Fits Your Vision"
                desc="Use our narrative writing services to turn your ideas into stories that will inspire, inform, and connect with your readers on an emotional level. Get in touch right away!"
            />
            <BrandBannerLogo />
            ...
            <div className="container mx-auto max-w-screen-xl overflow-hidden pt-0 md:py-20">
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-8 md:px-0 py-10 md:py-0">
                    <div className="basis-1/2 abt-txt m1-h p1 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
                        <h2 className="font-poppins text-3xl md:text-4xl uppercase font-bold">Hire Full-Length Novel Writing Services</h2>

                        <h2 className="font-poppins text-2xl md:text-3xl uppercase">
                            Novel Writing that Inspires Readers
                        </h2>

                        <p className="font-poppins text-xl text-left pt-3">
                            Do you have a wonderful concept for a book, but don't know how to start? We can help you with every step of writing a novel, from coming up with an outline and developing your characters to writing and editing your final draft. We help you tell your unique story by giving it good pacing, interesting dialogue, and well-rounded characters. </p>

                        <p className="font-poppins text-xl text-left pt-3">Our talented writers can develop novels that will keep you interested from the first page to the last, whether you want a romance, thriller, or sci-fi.</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-4 max-w-7xl mx-auto relative ">
                    ...
                    <div className="md:col-span-6 text-center px-4">
                        <h2 className="font-poppins text-2xl text-[#98caa9] font-semibold md:text-3xl uppercase">
                            Ready to Start Your Novel Writing Journey? Let’s Connect!
                        </h2>
                        <p className="text-base md:text-lg py-4">Work with professional writers who can help you develop a book that is worth publishing and sharing.</p>
