...
export default function BookEditing() {
    ...
    return (
        <>
            ...
            <BrandNavbar />
            <BrandPrimaryHeader
                photo_banner={"/brand-img/Childrens-Books.png"}
                title="Create Magical Stories - Expert Children’s Book Writing Service"
                desc="Want to write and publish a book that young readers would love? Here at Pine Book Writing, our team of writers helps create heartwarming tales, whether the purpose is to teach or entertain your audience."
            />
            <BrandBannerLogo />
            ...
            <div className="container mx-auto max-w-screen-xl overflow-hidden pt-0 md:py-20">
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-8 md:px-0 py-10 md:py-0">
                    ...
                    <h2 className="font-poppins text-3xl md:text-4xl uppercase font-bold">Pine Book Writing - Trusted Children’s Books Writing Company</h2>

                        <h2 className="font-poppins text-2xl md:text-3xl uppercase">
                        Stories That Satisfy Young’s Imagination
                        </h2>
                       
                        <p className="font-poppins text-xl text-left pt-3">
                        When it comes to writing for kids, you need more than just words. You need emotion, imagination, and a motive to infuse in the write-up. At Pine Book Writing, our crafted children's books are both fun and meaningful, combining imaginative stories with age-appropriate themes. </p>

                        <p className="font-poppins text-xl text-left pt-3">Our children's book writers conduct in-depth research, write with rhythm, clarity, and appeal, whether you're looking for a bedtime story, an early reader, or an instructive excursion. Our authors know how to get kids interested in reading by using interesting characters, straightforward morals, and creative tales. We can help you write a book that kids and parents will love to read and again read. Let's make something really special together!</p>
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-4 max-w-7xl mx-auto relative ">
                                ...
                                <div className="md:col-span-6 text-center px-4">
                                    <h2 className="font-poppins text-2xl text-[#98caa9] font-semibold md:text-3xl uppercase">
                                        Ready to Write Your Children’s Books with Us? Let’s Connect!
                                    </h2>
                                    <p className="text-base md:text-lg py-4">
                                        Contact us now to receive a free consultation on your project and let our experts craft a compelling narrative for your audience.
                                    </p>
