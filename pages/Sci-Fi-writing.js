...
export default function BookEditing() {
    ...
    return (
        <>
            ...
            <BrandNavbar />
            <BrandPrimaryHeader
                photo_banner={"/brand-img/Sci-Fi-writing.png"}
                title="Enter the World of Imaginations – Proficient Sci-Fi Writing Services"
                desc="Have an amazing science fiction story idea but lack the time and required skills? Don't worry! Pine Book Writing has an extensive team of sci-fi writing service providers/writers who are capable of turning your imagination into a real-world best-selling sci-fi book. Get in touch today to get a quote!"
            />
            <BrandBannerLogo />
            ...
            <div className="container mx-auto max-w-screen-xl overflow-hidden pt-0 md:py-20">
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-8 md:px-0 py-10 md:py-0">
                    ...
                    <h2 className="font-poppins text-3xl md:text-4xl uppercase font-bold">Cutting-Edge Sci-Fi Writing Service</h2>

                        <h2 className="font-poppins text-2xl md:text-3xl uppercase">
                        Helping Authors Create Amazing Sci-Fi Books
                        </h2>
                       
                        <p className="font-poppins text-xl text-left pt-3">
                        Science fiction opens up a world of possibilities. And our sci-fi writing service will help you get there. Help authors create stories that push the limits of what is possible while still being based on logic. These stories can be about space, time travel, or dystopian worlds. </p>

                        <p className="font-poppins text-xl text-left pt-3">Our team of sci-fi writers begins with planning, researching, and then they compose stories set in the future that presents believable science, exciting surprises, and themes that prompt thought. We suggest you introduce new places, consider noteworthy issues, and create memories that will last for long. We can help you develop a robust manuscript, whether you're new to sci-fi or have been a fan. Let's start creating the next great sci-fi story right now!</p>
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-4 max-w-7xl mx-auto relative ">
                                ...
                                <div className="md:col-span-6 text-center px-4">
                                    <h2 className="font-poppins text-2xl text-[#98caa9] font-semibold md:text-3xl uppercase">
                                        Ready to Create the Next Sci-Fi Best-Selling? Let’s Connect!
                                    </h2>
                                    <p className="text-base md:text-lg py-4">Partner with Pine Book Writing to work together with the experts of sci-fi genre and make a futuristic universe to life today!
                                    </p>
