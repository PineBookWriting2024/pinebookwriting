...
export default function BrandAbout(props) {
    ...
    return (
        <>
            <div className="container mx-auto max-w-screen-lg overflow-hidden md:pt-20 pb-10">
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-10 md:px-0 py-10 md:py-0 pb-0">
