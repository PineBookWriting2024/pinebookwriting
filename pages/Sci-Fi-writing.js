        ...
        <>
            ...
            <div className="container max-w-screen-xl pt-0 mx-auto overflow-hidden md:py-20">
                <div className="flex flex-col items-center justify-center px-8 py-10 md:flex-row lg:flex-row md:px-0 md:py-0">
                    ...
                    <h2 className="text-3xl font-bold uppercase font-poppins md:text-4xl">Cutting-Edge Sci-Fi Writing Service</h2>
            ...
            <section className="relative overflow-visible text-white bg-center bg-no-repeat bg-cover ser-cta-banner py-14 md:py-0"
                            ...
                            <div className="relative grid items-center grid-cols-1 gap-4 mx-auto md:grid-cols-12 max-w-7xl ">
                                ...
                                <div className="px-4 text-center md:col-span-6">
                                    ...
                                    <p className="py-4 text-base md:text-lg">Partner with Pine Book Writing to work together with the experts of sci-fi genre and make a futuristic universe to life today!
                                    </p>
