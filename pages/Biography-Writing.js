        ...
        <>
            ...
            <div className="container mx-auto max-w-screen-xl overflow-hidden pt-0 md:py-20">
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-8 md:px-0 py-10 md:py-0">
                    ...
                    <h2 className="font-poppins text-3xl md:text-4xl uppercase font-bold">Professional Biography Writing Services</h2>
                        ...
                        <p className="font-poppins text-xl text-left pt-3">Our team of biography writers ensures each word is written with clarity and purpose. They work diligently and closely with you, from initial consultation to final draft delivery, to help you preserve your story and shape it into a gripping narrative. We take time to understand your story and voice, but never compromise on the quality of work. Let’s write about your life story and turn it into a legacy!</p>
                    </div>
