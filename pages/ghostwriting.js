            ...
            <div className="container max-w-screen-xl pt-0 mx-auto overflow-hidden md:py-20">
                <div className="flex flex-col items-center justify-center px-8 py-10 md:flex-row lg:flex-row md:px-0 md:py-0">
                    <div className="basis-1/2 abt-txt m1-h p1 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
                        ...
                        <p className="pt-3 text-xl text-left font-poppins">Moreover, we believe in trust, transparency, and results. That's why we will allocate a dedicated project manager to update you about everything throughout the writing project. Contact us today to learn further about our service and get a project quote!</p>
                    </div>
