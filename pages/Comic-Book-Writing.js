...
export default function BookEditing() {
    ...
    return (
        <>
            <Head>
                <title>Comic Book Writing | Pine Book Writing</title>
                <meta
                    name="description"
                    content="Produce different dynamic heroes and plots with our comic book writing service. Our services are designed for visual storytelling and classic adventures."
                />
            ...
            <BrandNavbar />
            <BrandPrimaryHeader
                photo_banner={"/brand-img/Comic-Book-writing.png"}
                title="Art, Adventure, Magic – Expert Comic Book Writing Service"
                desc="We can help bring your universe to life with expert comic book writing services. Our comic book writers can bring bold heroes, magical worlds, and adventures together with their expertise in exceptional and artful storytelling and visual-friendly script writing. Create your comic story with us today!"
            />
            <BrandBannerLogo />
            ...
            <div className="container mx-auto max-w-screen-xl overflow-hidden pt-0 md:py-20">
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-8 md:px-0 py-10 md:py-0">
                    ...
                    <h2 className="font-poppins text-3xl md:text-4xl uppercase font-bold">Create the World of Imagination Comic Book Writing Services</h2>

                        <h2 className="font-poppins text-2xl md:text-3xl uppercase">
                        Unique Characters, Engaging Plots
                        </h2>
                       
                        <p className="font-poppins text-xl text-left pt-3">
                        Our comic book writing service is for people who wish to write stories that are bold and visual and stand out. In the comic book business, which is booming quickly these days, a good script is equally as crucial as good art. That's why our work is all about coming up with original stories, memorable characters, and interesting conversations that artists can easily bring to life. </p>

                        <p className="font-poppins text-xl text-left pt-3">Before we write a script that fits your vision, our team will work closely with you to understand your idea, tone, and audience. Let's create a wonderful and engaging comic book, get in touch now!</p>
                    </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-4 max-w-7xl mx-auto relative ">
                                            ...
                                            <div className="md:col-span-6 text-center px-4">
                                                <h2 className="font-poppins text-2xl text-[#98caa9] font-semibold md:text-3xl uppercase">
                                                    Let’s Script Your Next Comic Hit with Our Comic Book Writing 
                                                </h2>
                                                <p className="text-base md:text-lg py-4">
                                                    Enter the world of imagination and make your childhood dream come true with Pine Book Writing!
                                                </p>
