...
export default function BookEditing() {
    ...
    return (
        <>
            ...
            <BrandNavbar />
            <BrandPrimaryHeader
                photo_banner={"/brand-img/Speech-Writing.png"}
            ...
            <div className="container mx-auto max-w-screen-xl overflow-hidden pt-0 md:py-20">
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-8 md:px-0 py-10 md:py-0">
                    <div className="basis-1/2 abt-txt m1-h p1 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
                        <h2 className="font-poppins text-3xl md:text-4xl uppercase font-bold">Your Trusted Speech Writing Service</h2>
                        ...
                        <p className="font-poppins text-xl text-left pt-3">We'll make sure that your voice comes through in every context, whether you want something that motivates, moves, or persuades. Get guidance from a pro to make your speech memorable, polished, and ready for the spotlight.</p>
                    </div>
            ...
            <section className="ser-cta-banner bg-no-repeat bg-cover bg-center text-white relative overflow-visible py-14 md:py-0"
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-4 max-w-7xl mx-auto relative ">
                    ...
                    <div className="md:col-span-6 text-center px-4">
                        ...
                        <p className="text-base md:text-lg py-4">Get a speech made just for you and your event. Start the journey today!</p>
