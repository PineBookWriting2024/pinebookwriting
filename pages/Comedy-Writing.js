...
export default function BookEditing() {
    ...
    return (
        <>
            ...
            <BrandNavbar />
            <BrandPrimaryHeader
                photo_banner={"/brand-img/Comedy-Writing.png"}
                title="Humorous, Cool, & Hilarious - Comedy Writing Services"
                desc="Add humor to your comedy that brings laughs with our comedy writing services. We write comedy for shows, stand-up comedy, or any kind of literature or script that needs a funny twist. Get in touch right away!"
            />
            <BrandBannerLogo />
            ...
            <div className="container mx-auto max-w-screen-xl overflow-hidden pt-0 md:py-20">
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-8 md:px-0 py-10 md:py-0">
                    ...
                    <h2 className="font-poppins text-3xl md:text-4xl uppercase font-bold">Expert Comedy Writing Service for Any Style</h2>
